...
<script type="text/javascript">
    ...
    $('#datatable-stock').on('click', '.btn-delete[data-remote]', function (e) { 
        e.preventDefault();
        $.ajaxSetup({
            headers: {
        ...
        if(confirm('Apakah Anda yakin ingin menghapus data ini?')) {
            $.ajax({
                ...
                $('#datatable-stock').DataTable().draw(false);
            });
        }
    });
</script>
...
@section('content')
    <div class="row mt-5 mb-5">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="float-right">
                <a class="btn btn-success" href="{{ route('stock.create') }}"> Input Stock</a>
            </div>
        </div>
    </div>
    ...
    <div class="container mt-5">
        <h1 class="mb-4 text-center">Data Stock</h1>
        <table id="datatable-stock" class="table table-bordered">
            <thead>
                <tr>
